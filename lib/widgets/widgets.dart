...
// Material + InkWell: reliable hit targets vs CupertinoButton on nested Containers.
    return Material(
      color: Colors.transparent,
      child: InkWell(
        borderRadius: BorderRadius.circular(media.width * 0.02),
        splashColor: theme.withOpacity(0.22),
        highlightColor: theme.withOpacity(0.08),
        onTap: widget.onTap,
        child: Container(
      ...
      children: [
        InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: const Color.fromARGB(255, 177, 174, 174).withOpacity(0.1),
              border: Border.all(
                  color: (border)
                      ? (isDarkTheme)
                          ? theme
